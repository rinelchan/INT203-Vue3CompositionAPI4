<script setup>
import { ref } from 'vue'
const id = 63130500035
const name = 'Nutwara Boonyangkongkaew'

const italicText = 'italic'
const isItalic = false
const propItalic = 'font-style:italic'
...
<template>
  ...
  <p :style="{color:invalidMessage, 'font-style': italicText}">
    {{ id }}
  </p>
  <p :style="{ color: isItalic ? 'red' : 'green' }">
    {{ name }}
  </p>
  ...
  <div class="top-container">
    ...
    <div class="error-message">
      ...
      <p :class="[duplicate ? rand : '']">Sorry, Your number is already exist in the bingo sheet, please generate new number again!</p>
    </div>
    ...
    <div class="grid-container">
      <div class="grid-item">
        ...
        <span class="grid-item">Add Number</span>
        <span class="grid-item">Add Number</span>
        <span class="grid-item">Add Number</span>
    ...
    <div class="generate-number">
      ...
      <li>generateNumber #1: {{ randNumbers }}</li>
      <li>generateNumber #2: {{ randNumbers }}</li> 
    </div>
  </div>
</template>
